...
describe("ENS functions", () => {
  ...
  it("computes the namehash of an ENS domain", () => {
    ...
    expect(hash).to.equal(
      "0xbe0b801f52a20451e2845cf346b7c8de65f4beca0ebba17c14ce601de7bbc7fb"
    );
  });
  ...
  //获取 ENS address的pubilc keys 过时了
