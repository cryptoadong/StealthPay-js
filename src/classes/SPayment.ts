...
const umbraAddress = '0xB3c8CF53FE45d8fde16Bca13D9BD60E50Dae36F3'; // same on all supported networks
const subgraphs = {
...
export class SPayment {
  ...
  readonly umbraContract: SPaymentContract;
  ...
  constructor(readonly provider: EthersProvider, chainConfig: ChainConfig | number) {
    ...
    this.umbraContract = new Contract(this.chainConfig.umbraAddress, abi, provider) as SPaymentContract;
